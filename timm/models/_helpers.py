...
def load_state_dict(
    ...
    if checkpoint_path and os.path.isfile(checkpoint_path):
        ...
        if str(checkpoint_path).endswith(".safetensors"):
            ...
            # timm training checkpoints may contain argparse/optimizer objects.
            # This preserves the v0.9.16 behavior under PyTorch 2.6+, whose
            # torch.load default changed. Only load checkpoints you trust.
...
def resume_checkpoint(
    ...
    if os.path.isfile(checkpoint_path):
        # Resume metadata requires full unpickling; only load trusted files.
        checkpoint = torch.load(
